...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tight-lab-02d1
```

A live public deployment of this template is available at [https://tight-lab-02d1.templates.workers.dev](https://tight-lab-02d1.templates.workers.dev)
